...
export const PropiedadFiltrarWrapper = ({
  label = "Filtrar",
  options,
  selectedOptions,
  isOpen = false,
    ...
    <div className={`${containerBase} ${zClass} ${className}`}>
      <button
        ...
        className={`relative w-full rounded-[32px] ${
          isOpen
            ? "flex items-center gap-2 bg-[linear-gradient(119deg,rgba(135,0,5,1)_12%,rgba(172,7,13,1)_45%,rgba(208,29,35,1)_75%,rgba(236,76,81,1)_100%)] px-[38px] py-5 font-h3-subdivisiones text-[length:var(--h3-subdivisiones-font-size)] leading-[var(--h3-subdivisiones-line-height)] text-white"
