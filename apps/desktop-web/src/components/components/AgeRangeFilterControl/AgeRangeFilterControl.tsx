    ...
    <div className={`${containerBase} ${zClass} ${className}`}>
      <button
        ...
        className={`relative w-full rounded-[32px] ${
          isOpen
            ? "flex items-center justify-center gap-2 bg-brand-gradient px-[38px] py-5 font-h3-subdivisiones text-[length:var(--h3-subdivisiones-font-size)] text-white leading-[var(--h3-subdivisiones-line-height)]"
